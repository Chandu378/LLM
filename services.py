...
1. Answer in MAXIMUM 1-2 lines with exact facts from clauses
2. Use specific numbers, amounts, percentages, timeframes from the text
3. If no relevant information exists, respond: "Not specified in policy"
4. Be 200% accurate - only state what is explicitly written
5. Return ONLY valid JSON, no other text
6. Use this EXACT format:

{{
    "answer": "Maximum 2 sentences with exact facts from clauses",
    "conditions": ["Specific conditions/limitations from text"],
    "clause_id": "Most relevant clause ID",
    "score": 0.95,
    "explanation": "One sentence explaining relevance"
}}
